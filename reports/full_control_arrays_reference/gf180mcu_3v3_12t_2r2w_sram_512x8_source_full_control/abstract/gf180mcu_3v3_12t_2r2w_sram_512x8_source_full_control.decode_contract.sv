// Synthesizable decode/control contract for gf180mcu_3v3_12t_2r2w_sram_512x8_source_full_control.
// External MCU-facing address remains flat addr[8:0].
// Internal physical split is bank=addr[8:7], row=addr[6:0].
module gf180mcu_3v3_12t_2r2w_sram_512x8_source_full_control_periphery_decode_contract #(

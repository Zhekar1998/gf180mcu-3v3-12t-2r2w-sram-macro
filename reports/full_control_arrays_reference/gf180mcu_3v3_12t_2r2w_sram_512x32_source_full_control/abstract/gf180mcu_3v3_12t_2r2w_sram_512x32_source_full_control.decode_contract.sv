// Synthesizable decode/control contract for gf180mcu_3v3_12t_2r2w_sram_512x32_source_full_control.
// External MCU-facing address remains flat addr[8:0].
// Internal physical split is bank=addr[8:7], row=addr[6:0].
module gf180mcu_3v3_12t_2r2w_sram_512x32_source_full_control_periphery_decode_contract #(
    parameter int ROWS = 512,
    parameter int DATA_WIDTH = 32,
    parameter int BANKS = 4,
    parameter int ADDR_WIDTH = 9,
    parameter int BANK_ADDR_WIDTH = 2,
    parameter int ROW_ADDR_WIDTH = 7,
    parameter int ROWS_PER_BANK = 128
) (
    input  logic                         w0_en,
    input  logic                         w1_en,
    input  logic                         r0_en,

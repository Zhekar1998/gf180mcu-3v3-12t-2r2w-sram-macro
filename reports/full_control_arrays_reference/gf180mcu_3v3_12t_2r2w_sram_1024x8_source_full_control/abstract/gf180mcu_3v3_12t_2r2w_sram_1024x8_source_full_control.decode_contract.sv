// Synthesizable decode/control contract for gf180mcu_3v3_12t_2r2w_sram_1024x8_source_full_control.
// External MCU-facing address remains flat addr[9:0].
// Internal physical split is bank=addr[9:8], row=addr[7:0].
module gf180mcu_3v3_12t_2r2w_sram_1024x8_source_full_control_periphery_decode_contract #(
